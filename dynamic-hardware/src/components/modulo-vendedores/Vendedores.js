...
const Vendedores = () => {
  ...
  const obtenerVentas = async () => {
    const options = {
      method: 'GET',
      url: 'https://vast-castle-10160.herokuapp.com/obtenervendedores',
    };
    await axios
      .request(options)
  ...
  const enviarData = async (e) => {
    ...
    const options = {
      method: 'POST',
      url: 'https://vast-castle-10160.herokuapp.com/agregavendedores',
      ...
      <main className="main">
        ...
        <section>
          <form ref={formVenta} onSubmit={enviarData} id="formTable" action="" className="forms">
            ...
            <button type="reset" className="btn btn-verde">
              Eliminar
            </button>
          </form>
        </section>
